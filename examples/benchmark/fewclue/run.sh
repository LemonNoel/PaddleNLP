...
do
    for aug in ${augs[@]}
    do
        out_dir=./checkpoints/ckpt-24k-$task_name
        echo " "
        ...
        --seed 42 \
        --ckpt_model cmnli_ckpt24k.pdparams # 句间推理

        #--ckpt_model ckpt_36k_wsc20_4h.pdparams # 无监督阅读理解 + 指代
        ...
        #--ckpt_model strategy_supervised/model_4600_89.92.pdparams # 句间推理 + 文本匹配 
        #--ckpt_model "results/e1cw/cmnli/checkpoint-24000/model_state.pdparams" # 句间推理
        #--ckpt_model ckpt_36k_wsc20_4h_cmnli_19k.pdparams # 无监督阅读理解 + 指代 + 句间推理
        echo " "
